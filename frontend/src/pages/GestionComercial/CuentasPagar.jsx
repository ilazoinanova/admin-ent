...
import { Plus, Pencil, Power, FileText, History } from "lucide-react";
import { toast } from "react-hot-toast";
import { getPayables, createPayable, updatePayable } from "../../api/payables/payable.service";
...
export default function CuentasPagar() {
  ...
  const grid = "grid-cols-[2fr_1.2fr_1.4fr_1fr_1fr_1.2fr_90px_110px]";
